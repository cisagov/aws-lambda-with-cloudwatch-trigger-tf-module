...
```console
cd aws-lambda-with-cloudwatch-trigger-tf-module
pyenv virtualenv <python_version_to_use> aws-lambda-with-cloudwatch-trigger-tf-module
pyenv local aws-lambda-with-cloudwatch-trigger-tf-module
